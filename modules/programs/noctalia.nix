  ...
  flake.nixosModules.noctalia = {pkgs, lib, ...}: {
    ...
    programs.noctalia-shell = {
      ...
      settings = lib.mkForce {
            ...
            left = [
              {
                ...
                generalTooltipText = "Nixferatu";
                hideMode = "alwaysExpanded";
                icon = "snowflake";
                ipcIdentifier = "";
                leftClickExec = "vicinae open";
                ...
                parseJson = false;
                rightClickExec = "noctalia-shell ipc call sessionMenu toggle";
        ...
        general = {
          avatarImage = "/home/eduardo/Captures/image/pfp.jpg";
          dimmerOpacity = 0.2;
        ...
        wallpaper = {
          ...
          directory = "/home/eduardo/.config/wallpapers";
          monitorDirectories = [ ];
        ...
        sessionMenu = {
          ...
          powerOptions = [
            ...
            { action = "suspend"; enabled = true; keybind = "2"; command = ""; countdownEnabled = true; }
            { action = "hibernate"; enabled = true; keybind = "3"; command = ""; countdownEnabled = true; }
